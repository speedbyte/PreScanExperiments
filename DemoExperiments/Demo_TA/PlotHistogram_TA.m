function PlotHistogram_TA(simout,runnr,dirout)
% =========================================================================
...
% Update: Floris Leneman, April 2008    - Adapted for TA
%
...
% Derived settings
NumSweeps = floor(size(simout,2)/NumBeams);
...
% Get sreensize and make a near full screen figure
scrsz = get(0,'ScreenSize');
h=figure('Position',[1 100 scrsz(3) scrsz(4)-100]);


%round data
simout = round(1000*simout)/1000;

% Arrange the measurement data for each beams
NumSamples = NumSweeps*NumBeams; %ensure same vector sizes

Beam1.RangeData = simout(2,1:3:NumSamples);
Beam2.RangeData = simout(2,2:3:NumSamples);
Beam3.RangeData = simout(2,3:3:NumSamples);

Beam1.AziData = simout(3,1:3:NumSamples);
Beam2.AziData = simout(3,2:3:NumSamples);
Beam3.AziData = simout(3,3:3:NumSamples);

Beam1.ElevData = simout(4,1:3:NumSamples);
Beam2.ElevData = simout(4,2:3:NumSamples);
Beam3.ElevData = simout(4,3:3:NumSamples);
...
annotation(...
  'textbox',...
  'Position',[0.5 0.8 0.1 0.2],...
  'FontSize',16,...
  'FontWeight','bold',...
  'LineStyle','none',...
  'String',{['Run nr. ' num2str(runnr)]},...
  'FitHeightToText','on');
...
Outputfilename = 'Histogram';
fileout = sprintf('%s/%s_%05.0f.png',dirout,Outputfilename, runnr);
