function varargout = AP_ultrasonic_graph(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @AP_ultrasonic_graph_OpeningFcn, ...
                   'gui_OutputFcn',  @AP_ultrasonic_graph_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function AP_ultrasonic_graph_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = AP_ultrasonic_graph_OutputFcn(hObject, eventdata, handles) 
