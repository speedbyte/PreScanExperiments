function varargout = ACC_radar_graph(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @ACC_radar_graph_OpeningFcn, ...
                   'gui_OutputFcn',  @ACC_radar_graph_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function ACC_radar_graph_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = ACC_radar_graph_OutputFcn(hObject, eventdata, handles) 
